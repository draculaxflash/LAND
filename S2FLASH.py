...
bot = telebot.TeleBot('7759986591:AAEdCK_XcP5vuKSIUbszNSCu-orhfE8aVYo')
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in FLASH_cooldown and (datetime.datetime.now() - FLASH_cooldown[user_id]).seconds < 3:
                response = "You Are On Cooldown . Please Wait 60seconds Before Running The /FLASH Command Again."
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 200:
                ...
                full_command = f"./bgmi {target} {port} {time} 3200"
