...
bot = telebot.TeleBot('7822434388:AAFHhQnVoQbFP0JK_inwHOOTgbNnCsOxYNk')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @TG_FLASH92."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @TG_FLASH92 ."
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            response = "Usage: /FLASH <target> <port> <time>"
    else:
...
def show_help(message):
    help_text ='''
💥 /FLASH : 😫BGMI WALO KI MAA KO CHODO🥵. 
